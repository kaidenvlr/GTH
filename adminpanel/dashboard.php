                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <div class="card h-100 hover-scale-up cursor-pointer">
                    <div class="card-body d-flex flex-column align-items-center">
                      ...
                      <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">КОЛИЧЕСТВО ЦЕНТРОВ</div>
                      <div class="text-primary cta-4">
                        <?php
                          $sql = "select count(*) c from `center`;";
                          $res = $conn->query($sql);
                          $data = mysqli_fetch_assoc($res);
                          echo $data['c'];
                        ?></div>
                ...
                <div class="col-6 col-md-8 col-lg-6">
                  <div class="card h-100 hover-scale-up cursor-pointer">
                    <div class="card-body d-flex flex-column align-items-center">
                      ...
                      <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">КОЛИЧЕСТВО КОРТОВ</div>
                      <div class="text-primary cta-4">
                        <?php
                          $sqlCenter = "select ctid from `centerrole` where aid = " . $_SESSION['id'];
                          $resCenter = $conn -> query($sqlCenter);
                          ...
                          $sql = "select count(*) c from `court` where ctid = " . $dataCenter['ctid'];
                          $res = $conn -> query($sql);
                          $data = mysqli_fetch_assoc($res);
                          echo $data['c']
                        ?>
